                        ...
                        <div class="menu_main_wrap clearfix">
                            ...
                            <nav class="menu_main_nav_area">
								...
								<a href="<?php echo site_url('/'); ?>" class="[ logo-header-fijo ]">
									<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/logo-small1.png" alt="logo de pixan pequeño">
								</a>
                                <?php
								            ...
								            <?php
								                ...
								                <li class="menu_user_controls">
								                    <a href="<?php echo site_url('/my-account/'); ?>"><?php
								                        ...
								                        if ($user_avatar) {
														?><span class="user_avatar"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/user2.png" alt="imagen usuario"></span><?php
													}?></a>
								                </li>
								            <?php
								            }
