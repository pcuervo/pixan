...
<head>
	...
	<meta property="og:image" content="<?php echo get_stylesheet_directory_uri(); ?>/images/pixan-share.png">
	...
	<meta name="twitter:image" content="<?php echo get_stylesheet_directory_uri(); ?>/images/pixan-share.png" alt="Logo pixan" />
	<!-- Compatibility -->
