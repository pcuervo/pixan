	...
	function organics_messages_add_scripts_inline() {
		...
		echo '<script type="text/javascript">'
			...
			. 'ORGANICS_GLOBALS["strings"] = {'
				...
				. 'login_success:		"' . addslashes(esc_html__('Espera un momento...', 'organics')) . '",'
				. 'login_failed:		"' . addslashes(esc_html__('Fallo el ingreso', 'organics')) . '",'
				...
				. 'password_not_equal:	"' . addslashes(esc_html__('Las contraseñas en ambos campos no son iguales', 'organics')) . '",'
				. 'registration_success:"' . addslashes(esc_html__('Registro exitoso! Espera un momento...', 'organics')) . '",'
