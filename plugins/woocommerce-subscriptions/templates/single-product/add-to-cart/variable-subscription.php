				...
				<?php foreach ( $attributes as $attribute_name => $options ) : ?>
					<tr>
						...
						<td class="value">
							...
							echo wp_kses( end( $attribute_keys ) === $attribute_name ? '<a class="reset_variations" href="#">' . __( 'Borrar selección', 'woocommerce-subscriptions' ) . '</a>' : '', array( 'a' => array( 'class' => array(), 'href' => array() ) ) );
							?>
						</td>
					</tr>
				<?php endforeach;?>
