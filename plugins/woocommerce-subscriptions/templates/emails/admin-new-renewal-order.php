...
<p>
	...
	printf( esc_html_x( 'You have received a subscription renewal order from %1$s %2$s. Their order is as follows:', 'Used in admin email: new renewal order', 'woocommerce-subscriptions' ), esc_html( $order->billing_first_name ), esc_html( $order->billing_last_name ) );
	?>
</p>
