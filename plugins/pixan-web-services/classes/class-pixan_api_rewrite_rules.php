...
class PIXAN_API_Rewrite_Rules {
	 ...
	 *
	 * @return null|PIXAN_API_Rewrite_Rules
	 */
	...
	public function flush_rules() {
		...
		if ( ! isset( $rules[Pixan_Web_Service::WEBSERVICE_REWRITE] ) ) {
			global $wp_rewrite;
	...
	public function add_rewrite_rule( $rules ) {
		...
		$newrules                                            = array();
		$newrules[Pixan_Web_Service::WEBSERVICE_REWRITE] = 'index.php?webservice=1&service=$matches[1]';
